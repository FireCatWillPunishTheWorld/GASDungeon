                                            ...
                                            FEffectProperties& Properties) const
{
		...
		AbilityActorInfo->AvatarActor.IsValid())
	{
		...
		//if a controller from SourceASC is not found, try to get it from the avatar actor
		...
		//如果SourceController不为空 就直接当ACharacter处理 
...
void UAuraAttributeSet::PostGameplayEffectExecute(const FGameplayEffectModCallbackData& Data)
{
	...
	// Deal with attribute change after it happens limit it to maxValue
